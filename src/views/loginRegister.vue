        ...
        <div class="contain">
            <div :class="{active:isLogin}" class="big-box">
                <div class="big-contain" v-if="isLogin">
                    ...
                    <div class="bform">
                        <input placeholder="邮箱" type="email" v-model="form.useremail">
                        <span class="errTips" v-if="emailError">* 邮箱填写错误 *</span>
                        <input placeholder="密码" type="password" v-model="form.userpwd">
                        <span class="errTips" v-if="emailError">* 密码填写错误 *</span>
                    </div>
                    <button @click="login" class="bbutton">登录</button>
                </div>
                <div class="big-contain" v-else>
                    ...
                    <button @click="register" class="bbutton">注册</button>
                </div>
            </div>
